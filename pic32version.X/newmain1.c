...
int dly;
int timeBase = 1; //half a second - it was 500
...
void encode_ch(char ch)
{
    ...
    ch &= 0xDF;
int  volatile index = 1;

    //
     index = ch - 'A'; //need to try and replace with inline
    ...
    while(ch2){
        ...
        dly = ch2 - '0';  // converts from ascii to number //try to convert to inline asm
